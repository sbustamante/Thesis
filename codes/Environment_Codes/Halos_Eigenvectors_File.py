...
name_scheme = 'Vweb'
#Lambda_Filename
eigen_file = [ "snap_190.eigenvec_", "snap_191.eigen_", "snap_190.eigen_", "PMcrsFULL.0416.DAT.eigen_" ]
#eigen_file = [ "snap_191.s1.00.eigenvec_", "snap_191.s1.00.eigenvec_", "snap_190.s1.00.eigenvec_", "PMcrsFULL.0416.DAT.s1.00.eigenvec_" ]
...
for fold in folds:
    ...
    #Saving File
    np.savetxt("%s%s%s%d/Halos_Eigenvectors.dat"%(foldglobal, fold, scheme, res[i_fold]), halos_envinroment )
